...
const InstallCountFilter = (props) => {
  const { onAddInstallCount, value, operator } = props;
    ...
    <Dialog open={isFilterOpen} onOpenChange={toggleOpenHandler}>
      ...
      <DialogContent className='sm:max-w-[425px]'>
        <form noValidate onSubmit={customFilterFormik.handleSubmit}>
          <DialogHeader>
            <DialogTitle>Install Count Filter</DialogTitle>
          </DialogHeader>
...
export default InstallCountFilter;
